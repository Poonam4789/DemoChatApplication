package com.demo.example.demochatapplication.WebServices.connector;
...
import com.demo.example.demochatapplication.WebServices.Error.HttpConnetionError;
import com.demo.example.demochatapplication.WebServices.Util.HttpClientFactory;
import com.demo.example.demochatapplication.WebServices.model.OnWebServiceCompleteListener;
...
public final class WebServiceConnector
{
    ...
    private String getService(ServiceDataInfo info) throws IOException, URISyntaxException, HttpConnetionError, JSONException
    {
        ...
        httpGet.setHeader("api-key", DemoChatApplication.getAPIKEY());
    ...
    private String postServiceNameValuePair(ServiceDataInfo info) throws IOException, HttpConnetionError,JSONException
    {
        ...
        post.setHeader("api-key", DemoChatApplication.getAPIKEY());
