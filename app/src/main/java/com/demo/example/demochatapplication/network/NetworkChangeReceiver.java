package com.demo.example.demochatapplication.network;
...
import com.demo.example.demochatapplication.BuildConfig;
...
public class NetworkChangeReceiver extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent)
    {
        try
        {
            if (BuildConfig.FLAVOR.equalsIgnoreCase(DemoChatApplication.DEVELOPMENT_BUILD))
            {
